...
```{r}
# data_sample <- seq(1991, 2013)[which((seq(1991, 2013) %in% c(seq(1991,1992), seq(1993,2001), seq(2002,2003), seq(2008, 2009), seq(2011,2012) ,seq(2013))))]
...
po1 <-  lp_lin_panel(data_set          = ia1,
                               ...
                               instrum =   c('Education_exp', 'invwt', 'gdp_gro'), iv_reg = TRUE,
                               robust_cov   = "vcovSCC", robust_type="HC0", robust_cluster= "vcovHC",                                                          c_exog_data   = c('Gov_ex'),
                               lags_exog_data = 2,
                               l_exog_data    =c('Gov_ex'),
                               c_fd_exog_data = c('GDP_tren', 'Education_exp'),
                               l_fd_exog_data = c('GDP_tren', 'Education_exp'),
...
lp3 = data.frame(x =1:5,estm=c(po3[["irf_panel_mean"]]),low=c(po3[["irf_panel_low"]]),up=c(po3[["irf_panel_up"]]))
