...
# Usage example
ia1_e <- apply_prediction(fix, ia1)

```
```{r}

ia1_e$mdiff = (-(ia1_e$gi_bb-ia1_e$phat)*ia1_e$mu1/ia1_e$phat)-((ia1_e$gi_bb-ia1_e$phat)*ia1_e$mu0/(1-ia1_e$phat))

plot(ia1_e$mdiff, ia1_e$Gini_net)

ia1_e$inv= ((ia1_e$gi_bb/ia1_e$phat) + (1-ia1_e$gi_bb)/(1-ia1_e$phat))
ia1_e$iptw = (2*ia1_e$gi_bb-1)*(ia1_e$gi_bb*(ia1_e$inv))
plot((ia1_e$inv),ia1_e$Gini_net)

ia1_e$dr1 = ia1_e$iptw+ia1_e$mdiff

summary(lm(mdiff ~ 1, data=ia1_e))
```
