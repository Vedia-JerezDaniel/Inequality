...
wi_3 <- plm(Gini_net ~ lag(gdp_gro) + employ_rate +Trade +  Gov_ex + Education_exp,  data = panel.plm.df, 
   index=c("idem", "year"), model="within", effect = c("twoways"))
...
wi_7 <- plm(Gini_net ~ lag(gdp_gro) +employ_rate +Trade +  Gov_ex + Secondary_ed + Wages,  data = panel.plm.df,  index=c("idem", "year"), model="within", effect = c("twoways"))
...
ta1 = screenreg(list(wi_ex1, wi_ex2, wi_ex3, wi_ex4, wi_ex5, wi_ex6, wi_ex7, wi_ex8, wi_ex9),
          custom.model.names = c("TE_1","TE_2","TE_3","TE_4","TE_5","TE_6","TE_7","TE_8","TE_9"))
