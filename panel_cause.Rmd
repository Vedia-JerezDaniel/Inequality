...
## DIRECT POLICY VARIABLES
Soc_payable, "Soc_kind", "Education_exp", "Health_exp", "Social_prot", "Family"
...
wl_1 <- pvargmm(dependent_vars = c("Gini_net"), predet_vars = c("gdp_gro", "lgdp_g",'Gov_ex', "Trade"), lags = 1, exog_vars = c("employ_rate", 'Secondary_ed', 'Soc_payable'),  max_instr_predet_vars = 99, transformation = "fd", data = final, 
       panel_identifier = c('idem','year'), steps = c("onestep"),         system_instruments = FALSE, max_instr_dependent_vars = 99,       min_instr_dependent_vars = 1L,  min_instr_predet_vars = 1L, collapse = FALSE)

summary(wl_1)

wl_2 <- pvargmm(dependent_vars = c("Gini_net"), predet_vars = c("gdp_gro", 'Gov_ex', "Trade"), lags = 1, exog_vars = c("employ_rate", 'Secondary_ed', 'Soc_kind'),  max_instr_predet_vars = 9, transformation = "fd", data = final, 
       panel_identifier = c('idem','year'), steps = c("onestep"),         system_instruments = FALSE, max_instr_dependent_vars = 9,       min_instr_dependent_vars = 1L,  min_instr_predet_vars = 1L, collapse = FALSE)

summary(wl_2)

wl_3 <- pvargmm(dependent_vars = c("Gini_net"), predet_vars = c("gdp_gro", 'Gov_ex', "Trade"), lags = 1, exog_vars = c("employ_rate", 'Secondary_ed', 'Health_exp'),  max_instr_predet_vars = 9, transformation = "fd", data = final, 
       panel_identifier = c('idem','year'), steps = c("onestep"),         system_instruments = FALSE, max_instr_dependent_vars = 9,       min_instr_dependent_vars = 1L,  min_instr_predet_vars = 1L, collapse = FALSE)

summary(wl_3)

wl_4 <- pvargmm(dependent_vars = c("Gini_net"), predet_vars = c("gdp_gro", "lgdp_g",'Gov_ex', "Trade"), lags = 1, exog_vars = c("employ_rate", 'Secondary_ed', 'Education_exp'),        max_instr_predet_vars = 9, transformation = "fd", data = final, 
       panel_identifier = c('idem','year'), steps = c("onestep"),         system_instruments = FALSE, max_instr_dependent_vars = 9,
       min_instr_dependent_vars = 1L,  min_instr_predet_vars = 1L, collapse = FALSE)

summary(wl_4)

wl_5 <- pvargmm(dependent_vars = c("Gini_net"), predet_vars = c("gdp_gro", 'Gov_ex', "Trade"), lags = 1, exog_vars = c("employ_rate", 'Secondary_ed', 'Social_prot_ex_pen'),  max_instr_predet_vars = 9, transformation = "fd", data = final, 
       panel_identifier = c('idem','year'), steps = c("onestep"),         system_instruments = FALSE, max_instr_dependent_vars = 9,
       min_instr_dependent_vars = 1L,  min_instr_predet_vars = 1L, collapse = FALSE)

summary(wl_5)

wl_6 <- pvargmm(dependent_vars = c("Gini_net"), predet_vars = c("gdp_gro", 'Gov_ex', "Trade"), lags = 1, exog_vars = c("employ_rate", 'Secondary_ed', 'Unemp_tra'),  max_instr_predet_vars = 9, transformation = "fd", data = final, 
       panel_identifier = c('idem','year'), steps = c("onestep"),         system_instruments = FALSE, max_instr_dependent_vars = 9,
       min_instr_dependent_vars = 1L,  min_instr_predet_vars = 1L, collapse = FALSE)
