...
fe_ex1 <- coeftest(fe_1, vcovHC(fe_1, method = "arellano", cluster = 'time',type = "HC3"))
fe_ex2 <- coeftest(fe_2, vcovHC(fe_2, method  = "arellano", cluster = 'time', type = "HC3"))
...
library(texreg)
screenreg(list(fe_ex1, fe_ex2,wi_ex1, wi_ex2),
          custom.model.names = c("FE_1", "FE_2", "TI_1", "TI_2"))

# Analizando resultados (obteniendo parámetros)
fe_ex2[,1] / diff(range(final$Gini_net, na.rm = T))
```
