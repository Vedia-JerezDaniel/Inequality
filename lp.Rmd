...
```{r}
# READ HP
out1 <- read_delim("hp.csv", delim = ";", escape_double = FALSE, trim_ws = TRUE)

out1 <- out1 %>% mutate( booms = case_when(cycle > 0 ~ 1),
...
ln <- cbind(ln, out1[c("cycle", "trend", "booms", "bust", "gi_bb")])
