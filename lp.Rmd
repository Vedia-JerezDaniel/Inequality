...
cfi <- function(hori, me, low, up, color, tit) {
  ...
  polygon(c(hori,rev(hori)),c(low,rev(up)),density=7, col = 'azure4', border = NA)
...
cfi(lpr1$x,lpr1$estm,lpr1$low,lpr1$up, 'orange', 'Recession')
```
...
cfi(lpr2$x,lpr2$estm,lpr2$low,lpr2$up, 'orange', 'Recession')
```
...
cfi(lpr3$x,lpr3$estm,lpr3$low,lpr3$up, 'orange', 'Recession')
```
...
cfi(lpr4$x,lpr4$estm,lpr4$low,lpr4$up, 'orange', 'Recession')
```
...
cfi(lpr5$x,lpr5$estm,lpr5$low,lpr5$up, 'orange', 'Recession')
```
...
cfi(ltr1$x,ltr1$estm,ltr1$low,ltr1$up, 'orange', 'Recession')
```
...
cfi(ltr2$x,ltr2$estm,ltr2$low,ltr2$up, 'orange', 'Recession')
```
...
cfi(ltr3$x,ltr3$estm,ltr3$low,ltr3$up, 'orange', 'Recession')
```
...
cfi(ldr1$x,ldr1$estm,ldr1$low,ldr1$up, 'orange', 'Recession')
```
...
cfi(ldr2$x,ldr2$estm,ldr2$low,ldr2$up, 'orange', 'Recession')
```
...
cfi(ldr3$x,ldr3$estm,ldr3$low,ldr3$up, 'orange', 'Recession')
```
```{r}
library(clipr)
