...
gr = pgmm(formula = Gini_net ~ lag(Gini_net, 1:2) + lag(diff(GDP_con),0:1) + lag(Soc_kind, 0:1) 
          + lag(TOT, 0:1) + Trade | lag(Gini_net, 1:2) + lag(diff(GDP_con),1:2), data = ine2, effect = "individual", model = "twosteps")
