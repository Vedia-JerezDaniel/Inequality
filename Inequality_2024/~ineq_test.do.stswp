...
// EDUCATION EXP
forvalues i=0/4 {
	xtreg gini_net`i' dl.gini_net l(0/1).gdp_gro l(0/1).gov_ex l(0/1).education_exp`i' gdp_cycle, fe vce(robust)
	eststo ols`i'	
}
...
// HEALTH EXP
forvalues i=0/4 {
	xtreg gini_net`i' dl.gini_net l(0/1).gdp_gro l(0/1).gov_ex l(0/1).health_exp`i' gdp_cycle, fe vce(robust)
	eststo ols`i'	
}
...
// TRANSFERS IN PAY
forvalues i=0/4 {
	xtreg gini_net`i' dl.gini_net l(0/1).gdp_gro l(1).gov_ex l(0/1).soc_payable`i' gdp_cycle, fe vce(robust)
	eststo ols`i'	
}
...
// TRANSFERS IN KIND
forvalues i=0/4 {
	xtreg gini_net`i' dl.gini_net l(0/1).gdp_gro l(1).gov_ex l(0/1).soc_kind`i' gdp_cycle, fe vce(robust)
	eststo pols`i'	
}
...
// PROPERTY TAXATION
forvalues i=0/4 {
	xtreg gini_net`i' dl.gini_net l(0/1).gdp_gro l(1).gov_ex l(0/1).property_taxes`i' gdp_cycle, fe vce(robust)
	eststo ptols`i'	
}
