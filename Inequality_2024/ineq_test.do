...
forvalues i=0/4 {
	...
	xtreg gini_net`i' dl.gini_net l(0/1).gdp_gro l(0/1).gov_ex l(0/1).education_exp gdp_cycle, fe vce(robust)
...
forvalues i=0/4 {
	...
	xtreg gini_net`i' dl.gini_net l(0/1).gdp_gro l(0/1).gov_ex l(0/1).health_exp gdp_cycle, fe vce(robust)
...
forvalues i=0/4 {
	...
	xtreg gini_net`i' dl.gini_net l(0/1).gdp_gro l(1).gov_ex l(0/1).soc_payable gdp_cycle, fe vce(robust)
	
	eststo sols`i'	
}

esttab sols0 sols1 sols2 sols3 sols4 using results/Table_1/soc.rtf, ar2

// TRANSFERS IN KIND
forvalues i=0/4 {

	xtreg gini_net`i' dl.gini_net l(0/1).gdp_gro l(1).gov_ex l(0/1).soc_kind gdp_cycle, fe vce(robust)
	
	eststo pols`i'	
}

esttab pols0 pols1 pols2 pols3 pols4 using results/Table_1/kind.rtf, ar2

// INDIRECT TAXATION
forvalues i=0/4 {

	xtreg gini_net`i' dl.gini_net l(0/1).gdp_gro l(0/1).gov_ex l(0/1).ind_tx gdp_cycle, fe vce(robust)
	
	eststo itols`i'	
}
	
esttab itols0 itols1 itols2 itols3 itols4 using results/Table_1/ind_tx.rtf, ar2

// PROPERTY TAXATION
forvalues i=0/4 {

	xtreg gini_net`i' dl.gini_net l(0/1).gdp_gro l(1).gov_ex l(0/1).property_taxes gdp_cycle, fe vce(robust)
	
	eststo ptols`i'	
}

esttab ptols0 ptols1 ptols2 ptols3 ptols4 using results/Table_1/property_taxes.rtf, ar2
